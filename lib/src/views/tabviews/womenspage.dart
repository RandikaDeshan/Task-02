      ...
      body: FutureBuilder<List<Product>>(future: apiService.fetchAllData(), builder: (context, snapshot) {
        ...
        return Column(
          children: [
            ...
            Expanded(
              child: GridView.builder(gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: viewmode?2:1,childAspectRatio:viewmode? 0.46:1),itemCount: snapshot.data!.length, itemBuilder: (context, index) {
                Product product = snapshot.data![index];
                if(product.id < 20 &&product.id > 14){
